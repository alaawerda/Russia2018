...
use WorldCup\RussiaBundle\Entity\Ville;
...
class VilleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $villes = $em->getRepository('WorldCupRussiaBundle:Ville')->findAll();
    ...
    {
        $ville = new Ville();
        $form = $this->createForm('WorldCup\RussiaBundle\Form\VilleType', $ville);
    ...
    {
        $deleteForm = $this->createDeleteForm($ville);
        $editForm = $this->createForm('WorldCup\RussiaBundle\Form\VilleType', $ville);
