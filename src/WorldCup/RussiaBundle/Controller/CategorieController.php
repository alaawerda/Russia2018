...
use WorldCup\RussiaBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WorldCup\RussiaBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('WorldCup\RussiaBundle\Form\CategorieType', $categorie);
